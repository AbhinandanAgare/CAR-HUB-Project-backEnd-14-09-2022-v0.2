...
import com.app.service.ITestDrive;
...
//	public ResponseEntity<?> bookTest(@RequestBody bookTestDrive testDriveobj) {
//		System.out.println(testDriveobj.getCustomer());
//		System.out.println(testDriveobj.getCustomerId());
//		System.out.println(testDriveobj.getModelName());
//		System.out.println(testDriveobj.getTestDriveDate());
//		
//		bookTestDrive test = testDrive.Book(testDriveobj);
//		if (test == null) {
////			@PostMapping("/signup")
////			public ResponseEntity<?> userRegistration(@RequestBody SignUpRequest request) {
////				System.out.println("in user reg " + request);
...
//			return ResponseEntity.status(HttpStatus.NOT_FOUND).body(null);
//		}
//		return ResponseEntity.status(HttpStatus.CREATED).body(testDriveobj);
//	}
//	
////	@PostMapping("/bookTestDrive")
////	public ResponseEntity<?> bookTestDrive(@RequestBody bookTestDrive request) {
////		System.out.println("in user reg " + request);
////		return ResponseEntity.ok(testDrive.Book(request));
////	}
//	
	
	@PostMapping("/bookTestDrive")
	public ResponseEntity<?> bookService(@RequestBody TestDriveDto bs) {
		String e = testDrive.bookTestdrive(bs);
